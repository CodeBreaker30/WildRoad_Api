...
{
    public class TwitterApiClientHandler
    {
        ...
        /// </summary>
        public TwitterApiClientHandler(string consumerKey, string consumerKeySecret, string accessToken, string accessTokenSecret)
        {
